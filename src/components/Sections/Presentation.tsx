...
export default function Presentation() {
  ...
  return (
    <section className="w-full h-auto bg-linear-to-bl from-stone-800 to-stone-950 flex items-center justify-center overflow-hidden rounded-b-[3rem] py-20 px-4 md:px-10 lg:p-32">
      <div className="w-full max-w-7xl mt-7 lg:mt-0 flex flex-col lg:flex-row lg:gap-20 justify-between items-center gap-12 ">
        <div className="relative">
          <div className="w-full max-w-112.5 lg:max-w-none relative mx-auto md:p-8 lg:p-0 lg:border-none rounded-3xl flex flex-col gap-5 lg:text-left flex-1 order-2 lg:order-1">
            ...
            <p className="max-w-lg text-base md:text-[14pt] leading-relaxed text-stone-300">
              Construindo sistemas hoje, projetando o futuro da tecnologia
              amanhã.
            </p>
            <div className="flex flex-col lg:flex-row justify-center lg:justify-start gap-4 w-full">
              <Button01 to="#projects" />
              <Link
                to={"https://www.linkedin.com/in/franciscoentony/"}
                target="_blank"
            ...
            <div className="w-auto mt-5 lg:mt-0 flex gap-4 items-center justify-start">
              <Link
                to={"https://github.com/franciscoentony"}
                target="_blank"
                className="hover:text-emerald-500 relative bottom-0 hover:bottom-1 duration-200 ease-in-out"
              >
              ...
              <Link
                to={"mailto:francisoentonydev@gmail.com"}
                target="_blank"
                className="hover:text-emerald-500 relative bottom-0 hover:bottom-1 duration-200 ease-in-out"
              >
