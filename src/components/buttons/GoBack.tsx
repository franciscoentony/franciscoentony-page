...
const GoBack = () => {
  ...
  return (
    <button onClick={() => navigate(-1)} className="bg-white shadow-[0_0_2rem_0_#ffffff8a] text-center w-30 cursor-pointer flex justify-center items-center rounded-2xl h-10 relative text-black font-semibold group" type="button">
