  ...
  return (
    <StyledWrapper>
      <section className="relative overflow-hidden px-7 pt-44 pb-24 text-center flex items-center flex-col">
        ...
        <div className="avatar absolute w-100 h-150  -z-10 opacity-90">
        ...
        <div className="disponivel mt-50 mb-9 inline-flex items-center gap-2 rounded-full border border-line-strong bg-raised px-4 py-2 text-sm font-medium">
          <span className="h-1.75 w-1.75 rounded-full bg-emerald-400 shadow-[0_0_0_3px_rgba(62,207,110,0.18)]" />
          Disponível para novos projetos
        </div>

        <h1 className="texto-1 mx-auto mb-6 max-w-180 text-4xl font-bold leading-[1.08] sm:text-5xl">
          Eu programo e construo sistemas que resolvem problemas reais.
        </h1>
        <p className="texto-2 mx-auto mb-10 max-w-115 text-[17px] text-secondary">
          Sou o Entony, Desenvolvedor Full-Stack. Ajudo a conectar pessoas e
          organizações através de software bem construído — do front ao
          back-end.
        </p>
...
const StyledWrapper = styled.div`
  ...
  .texto-2 {
    opacity: 0;
    animation: fadeInTexts 2.5s ease-in-out forwards;
  }
  .texto-2 {
    animation-delay: 0.2s;
  }
  ...
  .disponivel {
    opacity: 0;
    animation: fadeInTexts 0.5s ease-in-out forwards;
  }
