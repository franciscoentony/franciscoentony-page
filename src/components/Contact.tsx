...
export default function Contact() {
  return (
    <section id="contato" className="mx-auto max-w-[880px] px-7 py-24">
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-[440px] text-[15px] text-secondary">
      ...
      <div className="grid grid-cols-1 gap-3.5 text-left sm:grid-cols-2">
        ...
        <div className="rounded-md border border-line bg-raised px-6 py-5">
          <span className="mb-2 block text-xs text-muted">Localização</span>
          <div className="text-[17px] font-semibold">Goianinha/RN</div>
        </div>
        <div className="rounded-md border border-line bg-raised px-6 py-5">
          <span className="mb-2 block text-xs text-muted">GitHub</span>
          <div className="text-[17px] font-semibold">github.com/franciscoentony</div>
        </div>
        <div className="rounded-md border border-line bg-raised px-6 py-5">
        ...
        >
          ...
          <span className="flex h-[38px] w-[38px] shrink-0 items-center justify-center rounded-full bg-accent">
            <FontAwesomeIcon icon={faArrowUpRightFromSquare} className="h-4 w-4 text-white" />
          </span>
        </a>
      </div>
    </section>
